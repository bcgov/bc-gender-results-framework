...
pov_5_2_1$household_food_security_status <- factor(pov_5_2_1$household_food_security_status,
                                                   levels = c("Food secure", "Food insecure, marginal", "Food insecure, moderate and severe"))
